...
import 'package:mythesis96/Api/omise_charge_model.dart';
import 'package:mythesis96/Api/omise_token_model.dart';
class Omiseuse extends StatefulWidget {
  Omiseuse({Key key}) : super(key: key);

  @override
  _OmiseuseState createState() => _OmiseuseState();
}

class _OmiseuseState extends State<Omiseuse> {
  @override
