...
class Detailcon2 extends StatefulWidget {
  Detailcon2({Key key}) : super(key: key);

  @override
  _DetailconState createState() => _DetailconState();
}

class _DetailconState extends State<Detailcon2> {
  ...
  Widget build(BuildContext context) {
    ConNotifier2 conNotifier = Provider.of<ConNotifier2>(context, listen: false);
    return Scaffold(
      appBar: AppBar(
