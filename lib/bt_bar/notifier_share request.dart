...
class ShareNotifierreg with ChangeNotifier {
...
class ShareNotifierreg2 with ChangeNotifier {
  List<Sharereq> _shareList = [];
  Sharereq _currentShare;
...
class ShareNotifierreg3 with ChangeNotifier {
  List<Sharereq> _shareList = [];
  Sharereq _currentShare;
  ...
  class ShareNotifierrequest with ChangeNotifier {
  List<Sharereq> _shareList = [];
  Sharereq _currentShare;
...
class ShareNotifierrequest2 with ChangeNotifier {
  List<Sharereq> _shareList = [];
  Sharereq _currentShare;
