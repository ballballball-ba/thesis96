...
class SharefeedsIn10 extends StatefulWidget {
  SharefeedsIn10({Key key}) : super(key: key);

  @override
  _SharefeedsIn10State createState() => _SharefeedsIn10State();
}

class _SharefeedsIn10State extends State<SharefeedsIn10> {
  @override
  void initState() {
...
getShare(ShareNotifier shareNotifier) async {
  QuerySnapshot snapshot = await Firestore.instance
      ...
      // .collection('Shareposts')
     .where('Date', isGreaterThanOrEqualTo: '12/01/2020')
      .where('Date', isLessThanOrEqualTo: '12/31/2020')
      .getDocuments();
