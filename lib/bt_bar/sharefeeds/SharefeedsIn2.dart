...
class SharefeedsIn2 extends StatefulWidget {
  SharefeedsIn2({Key key}) : super(key: key);

  @override
  _SharefeedsIn2State createState() => _SharefeedsIn2State();
}

class _SharefeedsIn2State extends State<SharefeedsIn2> {
  @override
  void initState() {
...
getShare(ShareNotifier shareNotifier) async {
  QuerySnapshot snapshot = await Firestore.instance
      ...
      .where('Date', isGreaterThanOrEqualTo: '04/01/2020')
      .where('Date', isLessThanOrEqualTo: '04/31/2020')

      // .where('Concertname', isEqualTo: 'HYUKOH in Bkk 2020')
      // .collection('Shareposts')
