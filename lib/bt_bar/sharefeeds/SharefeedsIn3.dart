...
class SharefeedsIn3 extends StatefulWidget {
  SharefeedsIn3({Key key}) : super(key: key);

  @override
  _SharefeedsIn3State createState() => _SharefeedsIn3State();
}

class _SharefeedsIn3State extends State<SharefeedsIn3> {
  @override
  void initState() {
...
getShare(ShareNotifier shareNotifier) async {
  QuerySnapshot snapshot = await Firestore.instance
      ...
      .where('Date', isGreaterThanOrEqualTo: '05/01/2020')
      .where('Date', isLessThanOrEqualTo: '05/31/2020')
...
getShare2(ShareNotifier2 shareNotifier2) async {
  QuerySnapshot snapshot = await Firestore.instance
      ...
      // .where('Concertname', isEqualTo: 'AB6IX  “6IXENSE” IN Bkk')
      // .where('Seatyou2', isGreaterThanOrEqualTo: '1')
      //.collection('Shareposts')
      //.orderBy('timestamp', descending: true)
      .getDocuments();
