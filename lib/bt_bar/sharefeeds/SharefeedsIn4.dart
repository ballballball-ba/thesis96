...
class SharefeedsIn4 extends StatefulWidget {
  SharefeedsIn4({Key key}) : super(key: key);

  @override
  _SharefeedsIn4State createState() => _SharefeedsIn4State();
}

class _SharefeedsIn4State extends State<SharefeedsIn4> {
  @override
  void initState() {
...
getShare(ShareNotifier shareNotifier) async {
  QuerySnapshot snapshot = await Firestore.instance
      ...
      .where('Date', isGreaterThanOrEqualTo: '06/01/2020')
      .where('Date', isLessThanOrEqualTo: '06/31/2020')
