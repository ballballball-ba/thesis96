...
class SharefeedsIn5 extends StatefulWidget {
  SharefeedsIn5({Key key}) : super(key: key);

  @override
  _SharefeedsIn5State createState() => _SharefeedsIn5State();
}

class _SharefeedsIn5State extends State<SharefeedsIn5> {
  @override
  void initState() {
...
void getData() {
   ...
   final _firestore = Firestore.instance;
    _firestore.collection('Concert').document().snapshots().asyncMap((snap) async {
  ...
  var connamebar =['HYUKOH','IU','AB6IX','NOEL','GOT7','LIAM',
...
getShare(ShareNotifier shareNotifier) async {
  QuerySnapshot snapshot = await Firestore.instance
     ...
     // .where('Concertname', isEqualTo: 'Noel Gallagher’s  2020')
      // .collection('Shareposts')
             .where('Date', isGreaterThanOrEqualTo: '07/01/2020')
      .where('Date', isLessThanOrEqualTo: '07/31/2020')
