...
class SharefeedsIn6 extends StatefulWidget {
  SharefeedsIn6({Key key}) : super(key: key);

  @override
  _SharefeedsIn6State createState() => _SharefeedsIn6State();
}

class _SharefeedsIn6State extends State<SharefeedsIn6> {
  @override
  void initState() {
...
getShare(ShareNotifier shareNotifier) async {
  QuerySnapshot snapshot = await Firestore.instance
      ...
      // .collection('Shareposts')
     .where('Date', isGreaterThanOrEqualTo: '08/01/2020')
      .where('Date', isLessThanOrEqualTo: '08/31/2020')
      .getDocuments();
