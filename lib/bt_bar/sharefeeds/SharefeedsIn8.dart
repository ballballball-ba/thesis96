...
class SharefeedsIn8 extends StatefulWidget {
  SharefeedsIn8({Key key}) : super(key: key);

  @override
  _SharefeedsIn8State createState() => _SharefeedsIn8State();
}

class _SharefeedsIn8State extends State<SharefeedsIn8> {
  @override
  void initState() {
...
getShare(ShareNotifier shareNotifier) async {
  QuerySnapshot snapshot = await Firestore.instance
      ...
      // .collection('Shareposts')
      .where('Date', isGreaterThanOrEqualTo: '10/01/2020')
      .where('Date', isLessThanOrEqualTo: '10/31/2020')
      .getDocuments();
