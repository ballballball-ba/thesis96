...
class SharefeedsIn9 extends StatefulWidget {
  SharefeedsIn9({Key key}) : super(key: key);

  @override
  _SharefeedsIn9State createState() => _SharefeedsIn9State();
}

class _SharefeedsIn9State extends State<SharefeedsIn9> {
  @override
  void initState() {
...
getShare(ShareNotifier shareNotifier) async {
  QuerySnapshot snapshot = await Firestore.instance
      ...
      // .collection('Shareposts')
      .where('Date', isGreaterThanOrEqualTo: '11/01/2020')
      .where('Date', isLessThanOrEqualTo: '11/31/2020')
      .getDocuments();
