...
class Activitydrive extends StatefulWidget {
  Activitydrive({Key key}) : super(key: key);

  @override
  _ActivitydriveState createState() => _ActivitydriveState();
}

class _ActivitydriveState extends State<Activitydrive> {
  @override
  void initState() {
    ...
    ShareNotifierrequest1 shareNotifierrequest1 =
        Provider.of<ShareNotifierrequest1>(context, listen: false);

    getSharerequest(shareNotifierrequest1);
  ...
  Widget build(BuildContext context) {
    ...
    ShareNotifierrequest1 shareNotifierrequest1 = Provider.of<ShareNotifierrequest1>(context);
...
getSharerequest(ShareNotifierrequest1 shareNotifierrequest1) async {
  QuerySnapshot snapshot = await Firestore.instance
  ...
  shareNotifierrequest1.shareList = _shareList;
}
...
getShare2(ShareNotifier2 shareNotifier2) async {
  QuerySnapshot snapshot = await Firestore.instance
      ...
      // .document()
      .collection('Shareposts')
      // .where('AuthorId', isGreaterThanOrEqualTo: '1')
